...
?>
<h1>Halaman Trending</h1>
<p>
    <a href="tutors_input.php">
        <input type="button" class="btn btn-primary" value="Buat Halaman Trending Baru" />
    </a>
</p>
<?php
if ($sukses) {
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><img src="../gambar/<?php echo tutors_foto($r1['id'])?>" style="max-block-size:100px;max-inline-size:100px"/></td>
