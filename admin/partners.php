...
?>
<h1>Halaman Media Partners</h1>
<p>
    <a href="partners_input.php">
        <input type="button" class="btn btn-primary" value="Buat Halaman Media Partners Baru" />
    </a>
</p>
<?php
if ($sukses) {
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td><img src="../gambar/<?php echo partners_foto($r1['id'])?>" style="max-block-size:100px;max-inline-size:100px"/></td>
                ...
                <td>
                    ...
                    <a href="partners.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah yakin mau hapus data ini?')">
